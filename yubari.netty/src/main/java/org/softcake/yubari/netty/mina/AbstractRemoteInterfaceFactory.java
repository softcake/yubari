...
public abstract class AbstractRemoteInterfaceFactory {
    private RemoteCallSupport remoteCallSupport;

    public AbstractRemoteInterfaceFactory() {

    }

    public abstract <T> ProxyInterfaceContext<T> buildRemoteInterface(IoSessionWrapper var1,
