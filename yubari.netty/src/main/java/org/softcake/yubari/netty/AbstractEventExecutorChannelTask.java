...
abstract class AbstractEventExecutorChannelTask implements OrderedThreadPoolExecutor.OrderedRunnable {
    ...
    AbstractEventExecutorChannelTask(final ChannelHandlerContext ctx,
