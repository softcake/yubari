 ...
 */
public final class SendingErrorCheck extends AbstractSendingCheck {
    ...
    public SendingErrorCheck(final ChannelFuture channelFuture, final TransportClientSession clientSession) {
